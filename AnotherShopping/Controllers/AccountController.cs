...
namespace AnotherShopping.Controllers
{
    ...
    {
        //此页代码大多是ASP.NET MVC自动生成的
        //[Authorize(Roles = "S")] 的意思就是为其下面函数添加名为“S”的角色
        //即只有“S”角色的用户才能进入该函数，字符串“S”是自定义的
        ...
        /// <summary>
        /// Create a new role to the user， 为帐号添加角色网页
        /// </summary>
        /// <returns></returns>
        [Authorize(Roles = "S")]
        ...
        /// <summary>
        /// Add role to the user， 为帐号添加角色确认按钮
        /// </summary>
        ...
        /// <summary>
        /// Get all the roles for a particular user，查看角色按钮
        /// </summary>
        /// <param name="UserName"></param>
        /// <returns></returns>
        [Authorize(Roles = "S")]
